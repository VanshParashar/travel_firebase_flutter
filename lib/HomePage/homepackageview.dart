...
class HomePackageView extends StatefulWidget {
   HomePackageView({Key? key,required this.packname,required this.pcknumber}) : super(key: key);
  String packname;
  int pcknumber;


  @override
  State<HomePackageView> createState() => _HomePackageViewState();
}

class _HomePackageViewState extends State<HomePackageView> {
  List<String> docIDs = [];

  Future getDocId() async {
    await FirebaseFirestore.instance.collection('package').where('packageType',isEqualTo: widget.pcknumber).get().then(
